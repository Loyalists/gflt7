...
local f0_local0 = function()
    local f4_local0 = Dvar.ui_execdemo_cp
    return f4_local0:get()
end

local f0_local1 = function()
    local f5_local0 = Dvar.ui_execdemo_gamescom
    return f5_local0:get()
end

local f0_local2 = function()
    local f6_local0 = Dvar.ui_execdemo_beta
    return f6_local0:get()
end
...
CoD.LobbyMenus.ModeSelect = function(f12_arg0, f12_arg1, f12_arg2)
    if Engine.GetLobbyNetworkMode() == Enum.LobbyNetworkMode.LOBBY_NETWORKMODE_LIVE then
        ...
        if f12_arg2 == 1 then
            if LuaUtils.IsGamescomBuild() then
                local f12_local0 = Dvar.ui_disable_lan
                if not f12_local0:get() then
...
CoD.LobbyMenus.MPButtonsOnline = function(f26_arg0, f26_arg1, f26_arg2)
    ...
    local f26_local0 = Dvar.ui_execdemo_beta
    if (not not f26_local0:get() or IsStarterPack()) and IsStoreAvailable() then
        if CoD.isPC then
...
CoD.LobbyMenus.MPButtonsOnlinePublic = function(f27_arg0, f27_arg1, f27_arg2)
    ...
    if f27_local0 then
        ...
        if f27_local1 == Engine.GetPlaylistCategoryIdByName("core") or f27_local1 ==
            Engine.GetPlaylistCategoryIdByName("hardcore") then
            f0_local7(f27_arg1)
...
CoD.LobbyMenus.ZMButtonsOnline = function(f33_arg0, f33_arg1, f33_arg2)
    ...
    elseif f33_arg2 == 1 then
        ...
        f0_local5(f33_arg0, f33_arg1, CoD.LobbyButtons.ZM_TFOPTIONS)
        -- f0_local5(f33_arg0, f33_arg1, CoD.LobbyButtons.THEATER_ZM)
        f0_local7(f33_arg1)
    end
    f0_local5(f33_arg0, f33_arg1, CoD.LobbyButtons.ZM_CHARACTERS)
    f0_local5(f33_arg0, f33_arg1, CoD.LobbyButtons.OPEN_PERSONALIZATION_OPTIONS)
...
CoD.LobbyMenus.ZMButtonsPublicGame = function(f34_arg0, f34_arg1)
    if IsStarterPack() then
        ...
        f0_local5(f34_arg0, f34_arg1, CoD.LobbyButtons.OPEN_PERSONALIZATION_OPTIONS)
...
CoD.LobbyMenus.ZMButtonsCustomGame = function(f35_arg0, f35_arg1, f35_arg2)
    ...
    elseif f35_arg2 == 1 then
        ...
        f0_local5(f35_arg0, f35_arg1, CoD.LobbyButtons.ZM_TFOPTIONS)
        f0_local7(f35_arg1)
    ...
    f0_local5(f35_arg0, f35_arg1, CoD.LobbyButtons.OPEN_PERSONALIZATION_OPTIONS)
...
CoD.LobbyMenus.ZMButtonsLAN = function(f36_arg0, f36_arg1, f36_arg2)
    ...
    elseif f36_arg2 == 1 then
        ...
        f0_local5(f36_arg0, f36_arg1, CoD.LobbyButtons.ZM_TFOPTIONS)
        f0_local7(f36_arg1)
    end
    f0_local5(f36_arg0, f36_arg1, CoD.LobbyButtons.ZM_CHARACTERS)
    f0_local5(f36_arg0, f36_arg1, CoD.LobbyButtons.OPEN_PERSONALIZATION_OPTIONS)
...
CoD.LobbyMenus.AddButtonsForTarget = function(f40_arg0, f40_arg1)
    ...
    if Engine.IsLobbyActive(Enum.LobbyType.LOBBY_TYPE_GAME) then
        f40_local0 = Engine.GetModel(DataSources.LobbyRoot.getModel(f40_arg0), "gameClient.isHost")
    else
        f40_local0 = Engine.GetModel(DataSources.LobbyRoot.getModel(f40_arg0), "privateClient.isHost")
    end
    local f40_local1 = nil
    if f40_local0 ~= nil then
        f40_local1 = Engine.GetModelValue(f40_local0)
    else
        f40_local1 = 1
    end
    local f40_local2 = {}
    f0_local8[f40_arg1](f40_arg0, f40_local2, f40_local1)
    return f40_local2
end