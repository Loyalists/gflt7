...
DataSources.TFOptionsBot.getWidgetTypeForItem = function(f27_arg0, f27_arg1, f27_arg2)
    if f27_arg1 then
...
LUI.createMenu.TFOptionsBotPage = function(InstanceRef)
    local self = CoD.Menu.NewForUIEditor("TFOptionsBotPage")
    ...
    self.buttonModel = Engine.CreateModel(Engine.GetModelForController(InstanceRef),
        "TFOptionsBotPage.buttonPrompts")
    ...
    local widget = CoD.TFOptions_Bot_P1.new(self, InstanceRef)
