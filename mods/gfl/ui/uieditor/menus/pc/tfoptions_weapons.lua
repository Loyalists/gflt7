...
LUI.createMenu.TFOptionsWeaponsPage = function(InstanceRef)
    local self = CoD.Menu.NewForUIEditor("TFOptionsWeaponsPage")
    if f0_local2 then
        f0_local2(self, InstanceRef)
    end
    ...
    self.buttonModel = Engine.CreateModel(Engine.GetModelForController(InstanceRef),
        "TFOptionsWeaponsPage.buttonPrompts")
    ...
    local widget = CoD.TFOptions_Weapons_P1.new(self, InstanceRef)
