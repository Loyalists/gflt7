...
DataSources.TFOptionsPerksP1 = DataSourceHelpers.ListSetup("PC.TFOptionsPerksP1", function(f26_arg0)
    local f26_local0 = {}
...
DataSources.TFOptionsPerksP1.getWidgetTypeForItem = function(f27_arg0, f27_arg1, f27_arg2)
    if f27_arg1 then
...
LUI.createMenu.TFOptionsPerksPage = function(InstanceRef)
    local self = CoD.Menu.NewForUIEditor("TFOptionsPerksPage")
    ...
    self.buttonModel = Engine.CreateModel(Engine.GetModelForController(InstanceRef),
        "TFOptionsPerksPage.buttonPrompts")
    ...
    -- self:addElement(f31_local4)
    self.CategoryListLine = f31_local4
    ...
    self.CategoryListLine0 = f31_local6
    ...
    local widget = CoD.TFOptions_Perks_P1.new(self, InstanceRef)
