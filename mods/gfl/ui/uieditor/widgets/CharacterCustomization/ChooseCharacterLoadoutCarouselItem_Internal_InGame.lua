...
require( "ui.uieditor.widgets.CharacterCustomization.ChooseCharacterLoadoutCarouselItem_InfoArea_InGame" )
...
CoD.ChooseCharacterLoadoutCarouselItem_Internal_InGame = InheritFrom( LUI.UIElement )
CoD.ChooseCharacterLoadoutCarouselItem_Internal_InGame.new = function ( menu, controller )
	...
	self:setClass( CoD.ChooseCharacterLoadoutCarouselItem_Internal_InGame )
	self.id = "ChooseCharacterLoadoutCarouselItem_Internal_InGame"
	self.soundSet = "none"
	...
	local infoArea = CoD.ChooseCharacterLoadoutCarouselItem_InfoArea_InGame.new( menu, controller )
