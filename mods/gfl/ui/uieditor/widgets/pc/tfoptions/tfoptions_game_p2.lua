...
CoD.TFOptions_Game_P2 = InheritFrom(LUI.UIElement)
CoD.TFOptions_Game_P2.new = function (HudRef, InstanceRef)
	local Widget = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(Widget, InstanceRef)
	end
	Widget:setUseStencil(false)
	Widget:setClass(CoD.TFOptions_Game_P2)
	Widget.id = "TFOptions_Game_P2"
	...
	f2_local1:setDataSource("TFOptionsGameP2")
