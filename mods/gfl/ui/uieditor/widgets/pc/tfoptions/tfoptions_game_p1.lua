...
CoD.TFOptions_Game_P1 = InheritFrom(LUI.UIElement)
CoD.TFOptions_Game_P1.new = function (HudRef, InstanceRef)
	...
	Widget:setClass(CoD.TFOptions_Game_P1)
	Widget.id = "TFOptions_Game_P1"
	...
	gameOptionList:setDataSource("TFOptionsGameP1")
