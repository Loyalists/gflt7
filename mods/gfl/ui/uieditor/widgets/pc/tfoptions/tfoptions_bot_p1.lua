...
CoD.TFOptions_Bot_P1 = InheritFrom(LUI.UIElement)
CoD.TFOptions_Bot_P1.new = function (HudRef, InstanceRef)
	local Widget = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(Widget, InstanceRef)
	end
	Widget:setUseStencil(false)
	Widget:setClass(CoD.TFOptions_Bot_P1)
	Widget.id = "TFOptions_Bot_P1"
	...
	f2_local1:setDataSource("TFOptionsBot")
