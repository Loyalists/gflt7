...
CoD.StartMenu_Options_PC_Graphics_Video.new = function (HudRef, InstanceRef)
	local Widget = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(Widget, InstanceRef)
	end
	Widget:setUseStencil(false)
	Widget:setClass(CoD.StartMenu_Options_PC_Graphics_Video)
	Widget.id = "StartMenu_Options_PC_Graphics_Video"
	...
	f2_local1:setDataSource("OptionGraphicsVideo")
