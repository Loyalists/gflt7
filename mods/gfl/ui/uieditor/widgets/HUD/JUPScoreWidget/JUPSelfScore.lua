...
CoD.JUPSelfScore = InheritFrom( LUI.UIElement )
CoD.JUPSelfScore.new = function ( menu, controller )
	...
	self:setClass( CoD.JUPSelfScore )
	self.id = "JUPSelfScore"
