...
CoD.ZMNotificationContainer = InheritFrom( LUI.UIElement )
CoD.ZMNotificationContainer.new = function ( menu, controller )
	...
	self:setClass( CoD.ZMNotificationContainer )
	self.id = "ZMNotificationContainer"
	self.soundSet = "HUD"
