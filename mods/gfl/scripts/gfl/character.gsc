...
function init_character_table()
{
	...
	level.charactertable["generic"]["alva"] = &swap_to_alva;
...
function swap_to_alva()
{
	self detachall();
	self setmodel("t7_gfl_alva_fb");
	self thread character_util::set_character_name();
}
...
function swap_to_vector_p1()
{
	self detachall();
	self setmodel("t7_gfl_vector_p1_fb");
	self thread character_util::set_character_name();
}

function swap_to_vector_p2()
{
	self detachall();
